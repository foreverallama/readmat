...
@pytest.mark.parametrize(
    ...
    [
        (   {
            '_Class': 'datetime',
            '_Props': np.array({
                'data': np.array([['2025-04-01T12:00:00']], dtype='datetime64[ms]').reshape(1,1),
        ...
        (
            ...
            '_Class': 'datetime',
            '_Props': np.array({
                'data': np.array([['2025-04-01', '2025-04-03', '2025-04-05',
                                   '2025-04-02','2025-04-04','2025-04-06']], dtype='datetime64[ms]').reshape(2,3),
                'fmt': np.array([], dtype='U'),
                'tz': np.array([], dtype='U'),
                }).reshape(1,1),
            },
    ...
    ids=["datetime-basic", "datetime-timezone", "datetime-array", "datetime-empty", "datetime-format"]
)
