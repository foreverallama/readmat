...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            '_Class': 'duration',
            '_Props': np.array({
                'millis': (np.timedelta64(1,'h') + np.timedelta64(2,'m') + np.timedelta64(3,'s')).astype('timedelta64[ms]').reshape(1,1),
        ...
        (
            ...
            '_Class': 'duration',
            '_Props': np.array({
                'millis': np.array([10, 20, 30, 40, 50, 60], dtype='timedelta64[s]').reshape(2,3),
                'fmt': np.array(['s']),
                }).reshape(1,1),
            },
            "dur_array.mat",
    ...
    ids=["duration-seconds", "duration-minutes", "duration-hours", "duration-days", "duration-base", "duration-array", "duration-empty"]
)
